<template>
  <div class="typeList">
      ...
      <ul id="ul">
        <li v-for="(item,index) in shop"
          ...
          <div class="center">
            ...
            <p class="type"><span>{{item.foodType}}</span><span v-for="(arr,ix) in item.kouwei"
                :key="ix">{{arr}}</span></p>
          ...
          <div class="right">
            <div class="add">
              ...
              <p class="increat"><img src="../../../static/img/add.png"
                  @click="addClick(item.foodId,true)"></p>
              <p class="remove"> <img src="../../../static/img/remove.png"
                  @click="addClick(item.foodId,false)"></p>
            </div>
          </div>
        </li>
      </ul>
    ...
    <div class="bottom"
      ...
      <div class="pay">
        <div class="total"
          @click="payMoney"><span class="totalPrice">结算</span></div>
      </div>
    </div>
    <div class="bottom"
      v-show="!show">
